package com.yuesi.umeng.ysumeng;
...
/** YsumengPlugin */
public class YsumengPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "ysumeng");
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "ysumeng");
    channel.setMethodCallHandler(new YsumengPlugin());
  ...
  private void initCommon(List args) {
    ...
    boolean debug = Boolean.parseBoolean((String) args.get(3));
